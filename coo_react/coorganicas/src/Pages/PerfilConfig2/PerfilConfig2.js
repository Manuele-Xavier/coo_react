                ...
                <form  id="form_cadastro_conf" onSubmit={this.putUsuario} onReset={this.limpaForm}>
                            ...
                            <div className="btn_file_espaco">
                                ...
                                <label> <span>Cidade:</span>
                                    <input type="text" placeholder="Digite sua cidade..." aria-label="Digite sua cidade" name="cidade"  value ={this.state.putUsuario.cidade} onChange={this.putSetState}></input>
                                </label><br></br>
                                <label> <span>Cep:</span>
                                    <input type="text" placeholder="Digite o seu cep..." aria-label="Digite o seu cep" name="cep"  value ={this.state.putUsuario.cep} onChange={this.putSetState}></input>
                                </label><br></br>
                                <label> <span>Endereço:</span>
                                    <input type="text" placeholder="Digite o seu endereço..." aria-label="Digite o seu endereço" name="endereco"  value ={this.state.putUsuario.endereco} onChange={this.putSetState}></input>
                                </label><br></br>
                                <label> <span>Numero:</span>
                                    <input type="text" placeholder="Digite o seu numero..." aria-label="Digite o seu numero" name="numero"  value ={this.state.putUsuario.numero} onChange={this.putSetState}></input>
                                </label><br></br>
                                <label> <span>Telefone:</span>
                                    <input type="text" placeholder="Digite o seu telefone..." aria-label="Digite o seu telefone" name="telefone"  value ={this.state.putUsuario.telefone} onChange={this.putSetState}></input>
                                </label><br></br>
                                <div className="btns">
