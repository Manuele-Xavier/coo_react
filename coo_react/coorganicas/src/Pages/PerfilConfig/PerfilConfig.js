                ...
                <form  id="form_cadastro_conf" onSubmit={this.putUsuario} onReset={this.limpaForm}>   
                        ...
                        <div className="carde_receita">
                            ...
                            <div className="btn_file_espaco">
                                <label>
                                    <input type="file" aria-label="Digite o seu nome" name="imagemReceita" ref={this.state.imagemReceita} placeholder="Enviar arquivo..." id="img__inputt"/>
                                </label>
                            </div>
                        </div>
