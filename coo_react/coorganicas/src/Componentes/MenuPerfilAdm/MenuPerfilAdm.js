...
class MenuPerfilAdm extends Component{
    render(){
        return(
            ...
            <nav className="menu_perfil">
                ...
                <Link  to='/Perfil'  title="Meus produtos do site Coorgânicas" ><p>Perfil Agricultor</p></Link>
                <Link to = '/Perfil3'title="Cadastrar produtos do site Coorgânicas" ><p>Perfil Comunidade</p></Link> 
